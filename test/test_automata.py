...
def test_a_intersection_nfa():
    ...
    state_4 = finite_automaton.State(4)

    nfa1 = NondeterministicFiniteAutomaton()
    nfa1.add_transition(state_1, symb_1, state_2)
    nfa1.add_transition(state_1, symb_0, state_2)
    nfa1.add_transition(state_2, symb_0, state_2)
    nfa1.add_transition(state_1, symb_1, state_3)
    nfa1.add_transition(state_2, symb_1, state_3)
    nfa1.add_final_state(state_3)
    nfa1.add_start_state(state_1)
    assert not nfa1.accepts('1011')

    nfa2 = NondeterministicFiniteAutomaton()
    nfa2.add_transition(state_1, symb_1, state_2)
    nfa2.add_transition(state_2, symb_0, state_3)
    nfa2.add_transition(state_3, symb_1, state_3)
    nfa2.add_transition(state_3, symb_1, state_4)
    nfa2.add_transition(state_1, symb_1, state_4)
    nfa2.add_transition(state_1, symb_0, state_4)
    nfa2.add_final_state(state_4)
    nfa2.add_start_state(state_1)
